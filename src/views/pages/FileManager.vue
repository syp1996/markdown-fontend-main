            ...
            <div class="file-content-container">
                ...
                <div v-else class="file-content">
                    ...
                    <div class="content-display">
                        <TiptapEditor placeholder="开始输入..." height="100%" :content="selectedFile.rawItem.content"
                            :document-id="selectedFile.rawItem ? selectedFile.rawItem.id : null" :enable-user-input-auto-save="true"
                            :user-inactivity-delay="3000" @change="handleContentChange" @save-success="onSaveSuccess"
        ...
        <div v-if="showUpload" class="upload-modal-overlay" @click="closeUploadModal">
            <div class="upload-modal" @click.stop>
                ...
                <div class="upload-modal-body">
                    <div class="upload-area" :class="{ 'dragover': isDragOver, 'has-file': selectedFiles.length > 0 }"
                        @drop="handleDrop" @dragover.prevent="handleDragOver" @dragleave.prevent="handleDragLeave"
                    ...
                    <input ref="fileInput" type="file" multiple accept=".md,.markdown,text/markdown"
...
export default {
    ...
    beforeUnmount() {
        // 清理事件监听
        eventBus.off('file-selected', this.handleEvent)
    },
    created() {
        // 监听文件选择事件
        eventBus.on('file-selected', this.handleEvent)
    ...
    methods: {
        handleEvent(data) {
            this.selectedFile = markRaw(data)
            console.log('kkkkk', this.selectedFile)
            // Handle the event
        },
        emitEvent() {
            // Instead of eventBus.$emit
